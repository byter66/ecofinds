        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button onClick={handleSignIn} data-testid="button-getstarted">
                Get Started
              </Button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-lg">
                Discover amazing second-hand treasures while reducing your
                environmental impact. Every purchase helps create a more
                sustainable future.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                ...
                <div className="text-center">
                  <div
                    className="text-2xl font-bold text-primary"
                    data-testid="text-satisfaction-rate"
                  >
                    98%
                  </div>
                  <div className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div
                        ...
                        data-testid="text-monthly-impact"
                      >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our platform combines the best of sustainable shopping with modern
              technology to create a seamless, eco-friendly marketplace
              experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Every purchase shows real-time carbon footprint savings and
                  environmental benefits. Track your positive impact on the
                  planet.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  All products are carefully vetted with detailed condition
                  ratings and sustainability certifications from trusted
                  sellers.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Transparent pricing with no hidden fees. Support local sellers
                  while getting great deals on sustainable products.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Discover amazing finds that make a positive impact
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {[
              ...
              <Card
                key={product.id}
                className="product-card overflow-hidden hover:shadow-lg transition-all cursor-pointer"
              >
                <img
                  src={product.image}
                  alt={product.title}
                  ...
                  <div className="bg-muted p-2 rounded text-xs">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        ...
                        data-testid={`text-product-impact-${product.id}`}
                      >
                        {product.carbonSaved}
                      </span>
                    </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Building a sustainable future through conscious commerce. Every
